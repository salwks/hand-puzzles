...
- **손기술** (`sutda.html`) — 섯다 + 타짜식 손기술(밑장빼기, 쓰는 척, 바꿔치기, 표시패 읽기). 상대에게 들키면 문제의 패를 엎어 둔 채 전재산을 거는 결판(증명 내기)으로 전환되고, 상대는 멈춤 동안의 손 움직임을 텔로 읽는다.
- `index.html` — 게임 선택 화면.
...
손기술
- `app/sutda-logic.js` — 20장 덱, 족보, 암행어사·땡잡이·구사 판정 · `app/sutda-scene.js` — 펠트 테이블, 절차적 화투, 쪼기 · `app/sutda.js` — 딜·베팅 AI·손기술·의심·결판
